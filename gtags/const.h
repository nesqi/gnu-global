...
--accept-dotfiles\n\
       Accept dot files and dot directories. By default, gtags ignores them.\n\
-c, --compact\n\
       Make GTAGS in compact format.\n\
       This option does not influence GRTAGS,\n\
       because it is always made in compact format.\n\
--config[=name]\n\
...
--single-update file\n\
       Update tag files for single file by optimized method.\n\
